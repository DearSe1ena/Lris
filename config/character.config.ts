...
【外貌锚点】（用于立绘一致性）
黑色长发双马尾（暗红细闪定制丝带）、翠绿色眼睛、左侧头发别极简银色发夹、159cm、气质高贵自信、习惯性双手抱胸。两个状态：名流（露背黑礼服+黑手套+回眸自信笑+阳光都市落地窗+下午茶与红玫瑰）、午后（象牙白荷叶边针织背心+黑色缎带蝴蝶结+黑百褶短裙+过膝袜+金框扶手椅托腮沉思+强光落地窗+欧式街景+下午茶糕点）。
